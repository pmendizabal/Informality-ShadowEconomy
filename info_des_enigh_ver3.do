...
y  el negocio solo tiene hasta 5 trabajadores
...
replace tam_empr=0 if tam_emp>=02
...
gen ing_inf_neg_na= ing_tri if t_emp<=5 
*Ahora para los formales
gen ing_for_neg_na= ing_tri if t_emp>5 
...
order folio2
keep folioviv foliohog numren folio2 t_emp reg_not ing_tri
gen ing_inf_neg_a= ing_tri if t_emp<=5
*Pero para negocios formales no existen obervaciones
gen ing_for_neg_a= ing_tri if t_emp>5 
...
gen ing_inf_trab= ing_trab if tam_empr==1 
gen ing_for_trab= ing_trab if tam_empr==0 
