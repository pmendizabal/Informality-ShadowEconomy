...
*Generamos los ingresos provenientes de la informalidad
...
collapse (sum) ing_inf_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg08.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_08.dta", clear
collapse (sum) ing_for_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg08.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_08.dta", clear
...
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg08.dta", update
drop _merge
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg08.dta", update
drop _merge
...
*Ahora sumamos los ingresos generados por hogar
collapse (sum) ing_inf_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg10.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_10.dta", clear
collapse (sum) ing_for_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg10.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_10.dta", clear
collapse (sum) ing_inf_trab, by(folio3)
...
*Fusionamos con la base de concentrado que contiene la info sobre hogares, las bases sumadas por hogares previamente
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg10.dta", update
drop _merge
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg10.dta", update
drop _merge
...
*Ahora sumamos los ingresos generados por hogar
collapse (sum) ing_inf_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg12.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_12.dta", clear
collapse (sum) ing_for_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg12.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_12.dta", clear
collapse (sum) ing_inf_trab, by(folio3)
...
*Fusionamos con la base de concentrado que contiene la info sobre hogares, las bases sumadas por hogares previamente
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg12.dta", update
drop _merge
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg12.dta", update
drop _merge
...
*Ahora sumamos los ingresos generados por hogar
collapse (sum) ing_inf_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg14.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_14.dta", clear
collapse (sum) ing_for_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg14.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_14.dta", clear
collapse (sum) ing_inf_trab, by(folio3)
...
*Fusionamos con la base de concentrado que contiene la info sobre hogares, las bases sumadas por hogares previamente
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg14.dta", update
drop _merge
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg14.dta", update
drop _merge
...
*Ahora sumamos los ingresos generados por hogar
collapse (sum) ing_inf_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg16.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_16.dta", clear
collapse (sum) ing_for_neg, by(folio3)
save "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg16.dta", replace
use "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base definitiva\infor_desig_16.dta", clear
collapse (sum) ing_inf_trab, by(folio3)
...
*Fusionamos con la base de concentrado que contiene la info sobre hogares, las bases sumadas por hogares previamente
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_infneg16.dta", update
drop _merge
merge 1:1 folio3 using "C:\Users\Thosiba User\Documents\TESIS\Calculos\Bases generadas\Base sumadas\sum_forneg16.dta", update
drop _merge
